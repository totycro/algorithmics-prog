...
\begin{equation}\label{eq:mfcInFlow}
	\ilc{incomingFlowSum[commodity]} = \sum_{\mathclap{\forall \ilc{edge} \in \ilc{edges}| \ilc{edge.v2} = \ilc{commodity}}} \ilc{flow[commodity][edge]} 
...
\begin{equation}\label{eq:mfcFlowEdge}
 \ilc{flow[commodity][e]} \leq \ilc{edges[e]} \quad \forall \ilc{e}
